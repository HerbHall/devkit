...
| Skills (invoke with `/skill-name`) | 20 skills | `claude/skills/` |
...
| Directory | Purpose |
|-----------|---------|
| `claude/` | Global Claude Code config — CLAUDE.md, 10 rules files (135+ patterns), 20 skills, 7 agent templates, hooks |
...
| conformance-audit | 17-point project conformance checklist against DevKit standards | Code |
