...
- Be specific: "Add user list page with sorting and filtering" not "Dashboard work"
...
1. **Description**: 2-3 sentences explaining what and why. Reference the relevant planning or requirements doc.
2. **Acceptance Criteria**: Checkboxes (`- [ ]`) listing specific, testable conditions for "done"
3. **Requirements Reference**: Link to the relevant doc file and section (if the project has requirements docs)
...
- Link to requirements: `See [doc-name.md](path/to/doc-name.md)`
- Link to related issues: `Blocked by #42` or `Related to #15`
- Link to ADRs when relevant: `Per [ADR-0002](path/to/adr-0002.md)`
...
- Orphan issues: no phase label, no milestone, no area label
