...
## 11. jq Not Available on Windows MSYS by Default
...
**Fix:** Use Python's `json` module instead of `jq` for bash scripts that need JSON escaping/parsing. Python is more commonly available (once you work around gotcha #13).

## 12. UserPromptSubmit Hooks Block Slash Commands and Menu Selections
...
## 15. swag Generates Platform-Specific time.Duration Enums
...
## 16. Swagger Drift After Any Handler/Model Change
...
## 17. Go Nil Guard: Split Chained Nil Checks Into Separate Blocks
...
## 18. Squash-Merged Branches Don't Appear in `git branch --merged`
...
## 19. GitHub `Closes #N` Comma Syntax Only Closes First Issue
...
## 20. websocket.Dial Response Body Must Be Closed
...
## 21. Windows Start-Process Gives Child a Real Console (ModeCharDevice)
...
## 22. PowerShell 5.1 ConvertFrom-Json Drops Empty Arrays
...
## 23. Stacked PR Rebase After Squash-Merge Requires Skip
...
## 24. VS Code YAML Extension Conflict: jumpToSchema
...
## 25. Project Renames Create Competitive Research Blind Spots
...
## 26. GitHub Rulesets Return 404 on Branch Protection API
...
## 27. cla-assistant.io Blocks Dependabot PRs
...
## 28. Parallel Background Agents Share Working Tree
...
## 29. Sequential Same-File PR Merge Requires Rebase Between Each
...
## 30. SQLite strftime Returns NULL for RFC3339Nano Timestamps
...
## 31. Recharts v3 Uses TooltipContentProps, Not TooltipProps
...
## 32. Build-Tag Files Invisible to Local Lint on Different OS
...
## 33. Background Agents Can't Prompt for Tool Permissions
...
## 34. Reddit Blocks WebFetch but gh api Works
...
## 35. SessionStart Hook: Use `type: "command"` Not `type: "prompt"`
...
## 36. Claude Code Hooks Cannot Initiate Conversation
...
## 37. Chrome Ignores autocomplete="off" on Form Fields
...
## 47. Go Race Detection Requires CGO on Windows MSYS
...
## 38. Go uint64 Subtraction Wraps Instead of Going Negative
...
## 39. VS Code Locks Workspace Root Directories
...
## 46. .claude/settings.local.json Should Be Gitignored
...
## 48. BMAD Method Generates 42 Slash Commands in .claude/commands/
...
## 49. Spec Kit `specify init` Hangs on Windows MSYS
...
## 50. BMAD npm Package Name Is Not Obvious
