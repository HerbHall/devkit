...
Use shadcn/ui + Tailwind for styling. Adjust this section per project profile.

MUI projects: use `InputProps` (not `slotProps.input`) for TextField adornments on MUI v5.
